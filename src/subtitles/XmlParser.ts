...
export class YouTubeXMLParser {
  ...
  static parseXML(content: string, config: ParserConfig): ParseResult {
    ...
    try {
      ...
      console.log(`[LinguaTube] XML parsing completed: ${segments.length} segments in ${parseTime.toFixed(2)}ms`);
   ...
   */
  private static parseYouTubeXML(content: string, config: ParserConfig, errors: ParseError[]): SubtitleSegment[] {
   ...
   */
  private static parseTTML(content: string, config: ParserConfig, errors: ParseError[]): SubtitleSegment[] {
    const segments: SubtitleSegment[] = [];
   ...
   */
  private static parseGenericXML(content: string, config: ParserConfig, errors: ParseError[]): SubtitleSegment[] {
    const segments: SubtitleSegment[] = [];
   ...
   */
  private static parseTextElement(element: Element, index: number, config: ParserConfig): SubtitleSegment | null {
   ...
   */
  private static parseTTMLParagraph(element: Element, index: number, config: ParserConfig): SubtitleSegment | null {
   ...
   */
  private static parseGenericElement(element: Element, index: number, config: ParserConfig): SubtitleSegment | null {
   ...
   */
  private static postProcessSegments(segments: SubtitleSegment[], config: ParserConfig): SubtitleSegment[] {
   ...
   */
  private static mergeAdjacentSegments(segments: SubtitleSegment[], maxGap: number): SubtitleSegment[] {
